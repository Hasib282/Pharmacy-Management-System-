...
function addProduct($data){
    $conn = db_conn();
    $sql = "INSERT into product (Product_Id, Product_Name, Product_Price, Category_Id, Manufacturer_Id, Stock, Image) 
    VALUES (:Product_Id, :Product_Name, :Product_Price, :Category_Id, :Manufacturer_Id, :Stock, :Image)";
